...
![Piattaforma](https://img.shields.io/badge/piattaforma-Android-2E9C4A?style=flat-square)
...
### 🧾 Scanner scontrini
Inquadra qualsiasi scontrino cartaceo con la fotocamera. L'app legge e inserisce automaticamente il totale complessivo e il nome della spesa.

### 📊 Monitoraggio spese
Tieni sotto controllo le tue uscite per categoria: alimentari, carburante, abbigliamento, farmaci, elettronica, abbonamenti online e altro. Visualizza l'andamento nel tempo e confronta i vari periodi tra loro.
...
### Group mode
Crea un gruppo condiviso con amici (per viaggi, per esempio) o con la famiglia. Ognuno aggiunge le proprie spese, e tutti vedono una dashboard unificata con il budget comune e i movimenti recenti.
